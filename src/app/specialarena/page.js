  ...
  useEffect(() => {
    ...
    const animations = [
      ...
      },
      {
        ...
        target: "#myText2",
        duration: 5,
        text: "Bienvenido a la Arena de Trading Especial, diseñada para desafiar a los traders, utilizando herramientas avanzadas, inteligencia artificial y las apuestas más altas para una nueva experiencia de trading."
      },
      {
        trigger: ".purple",
        target: "#myText3",
        duration: 7,
        text: "El ganador superará a los competidores y reclamará la victoria demostrando un conocimiento y estrategia de trading superiores."
      },
      {
        trigger: ".purple",
        target: "#myText4",
      ...
      <div>
        <section className="panel green hover-gradient-amber-5 mx-auto text-center relative h-96">
          <div className="absolute inset-0">
            <Image src="/images/blog/specialpass.webp" alt="Imagen de Fondo" className="opacity-30" fill style={{ objectFit: "cover" }} />
        ...
        <section className="panel orange mx-auto text-center relative h-96">
          <div className="absolute inset-0">
            <Image src="/images/blog/specialarena.webp" alt="Imagen de Fondo" className="opacity-70" fill style={{ objectFit: "cover" }} />
            <div className="absolute inset-0 bg-black bg-opacity-50"></div>
          </div>
          <div className="relative z-10 p-6 flex items-center justify-center flex-col">
        ...
        <section className="panel purple mx-auto text-center relative h-96">
          <div className="absolute inset-0">
            <Image src="/images/blog/specialtrade.webp" alt="Imagen de Fondo" className="opacity-60 hover-gradient-amber-5 hoover:blur-xs rounded-lg z-0" fill style={{ objectFit: "cover" }} />
            <div className="absolute inset-0 bg-black bg-opacity-50"></div>
          </div>
          <div className="relative z-10 p-6 flex items-center justify-center flex-col">
