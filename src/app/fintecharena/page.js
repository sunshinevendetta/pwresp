  ...
  useEffect(() => {
    ...
    const animations = [
      ...
      },
      {
        ...
        target: "#myText2",
        duration: 5,
        text: "Bienvenido a Fintech Arena, diseñado para desafiar a los traders, utilizando una combinación de herramientas profesionales y estrategias dentro de un entorno de trading simulado sin riesgo y de alto riesgo."
      },
      {
        trigger: ".purple",
        target: "#myText3",
        duration: 7,
        text: "El ganador superará a los competidores y reclamará la victoria demostrando una visión y estrategia de trading superior."
      }
    ];
      ...
      <div>
        <section className="panel green hover-gradient-amber-5 mx-auto text-center relative h-96">
          <div className="absolute inset-0">
            <Image src="/images/blog/fintechpass.webp" alt="Imagen de Fondo" className="opacity-30" fill style={{ objectFit: "cover" }} />
        ...
        <section className="panel orange mx-auto text-center relative h-96">
          <div className="absolute inset-0">
            <Image src="/images/blog/fintech2.webp" alt="Imagen de Fondo" className="opacity-70" fill style={{ objectFit: "cover" }} />
            <div className="absolute inset-0 bg-black bg-opacity-50"></div>
          </div>
          <div className="relative z-10 p-6 flex items-center justify-center flex-col">
        ...
        <section className="panel purple mx-auto text-center relative h-96">
          <div className="absolute inset-0">
            <Image src="/images/blog/fintech.webp" alt="Imagen de Fondo" className="opacity-60 hover-gradient-amber-5 hoover:blur-xs rounded-lg z-0" fill style={{ objectFit: "cover" }} />
            <div className="absolute inset-0 bg-black bg-opacity-50"></div>
          </div>
          <div className="relative z-10 p-6 flex items-center justify-center flex-col">
