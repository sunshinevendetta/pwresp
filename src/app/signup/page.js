...
export default function Signup(){
    return(
        <>
        <section className="relative overflow-hidden h-screen flex items-center  bg-no-repeat bg-left bg-cover bg-fixed " style={{backgroundImage:"url('/images/bg/bg-ai.webp')"}}>
                ...
                <div className="md:flex justify-end">
                    <div className="lg:w-1/3 md:w-2/4">
                        <div className="rounded shadow bg-white dark:bg-slate-900 p-6">
                            <Link href="/">
                                <Image src="/images/logo-icon-64.webp" width={64} height={64} alt=""/>
                            </Link>

                            <h5 className="mt-6 text-xl font-semibold">Create an accounasdasdat</h5>
