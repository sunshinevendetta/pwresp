    ...
    <>
      <div className="max-w-3xl mx-auto mt-6 gap-6">
        <div className="relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
          <div className="p-6">
            <h5 className="text-2xl leading-normal font-semibold">Traders</h5>
            <p className="text-slate-400 mt-2">Para aquellos que se atreven a construir la gloria y demostrar que son los mejores</p>
            ...
            <div className="mt-6 flex items-center">
              ...
              <Link href="https://tally.so/r/mD104p" target="_blank">
                <button className="py-2 px-5 font-semibold tracking-wide border align-middle duration-500 text-base text-center rounded">Más Información</button>
              </Link>
            </div>
          </div>
