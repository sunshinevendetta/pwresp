...
export default function Blogs() {
  // Filtrar datos del blog para incluir solo entradas con etiquetas "Trading" o "Trading Tournament"
  const filteredBlogData = blogData.filter(item =>
    item.tags && (item.tags.includes("Trading") || item.tags.includes("Trading Tournament"))
  );
    ...
    <>
      <div className="container relative md:mt-24 mt-16">
        <div className="grid grid-cols-1 pb-6 text-center">
          <h3 className="mb-4 md:text-2xl md:leading-normal text-2xl leading-normal font-semibold">Noticias de Trading</h3>
          <p className="text-slate-400 max-w-xl mx-auto">Información enfocada en Trading y Torneos de Trading para potenciar tus innovaciones.</p>
        </div>
