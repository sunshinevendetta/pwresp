...
export default function Blogs() {
  // Filtrar datos de blogs para incluir solo entradas con etiquetas "Web3" o "Hackathon"
  const filteredBlogData = blogData.filter(item =>
    item.tags && (item.tags.includes("Web3") || item.tags.includes("Hackathon"))
  );
    ...
    <>
      <div className="container relative md:mt-24 mt-16">
        <div className="grid grid-cols-1 pb-6 text-center">
          <h3 className="mb-4 md:text-2xl md:leading-normal text-2xl leading-normal font-semibold">Noticias de Web3</h3>
          <p className="text-slate-400 max-w-xl mx-auto">Perspectivas enfocadas en Web3 y Hackathons para impulsar tus innovaciones.</p>
        </div>
