...
export default function Blogs() {
  // Filtrar datos del blog para incluir solo entradas con etiquetas "Art" o "Contest"
  const filteredBlogData = blogData.filter(item =>
    item.tags && (item.tags.includes("Art") || item.tags.includes("Contest"))
  );
    ...
    <>
      <div className="container relative md:mt-24 mt-16">
        <div className="grid grid-cols-1 pb-6 text-center">
          <h3 className="mb-4 md:text-2xl md:leading-normal text-2xl leading-normal font-semibold">Noticias de Arte</h3>
          <p className="text-white rounded-xl bg-black bg-opacity-70">Perspectivas centradas en el Arte para impulsar tus innovaciones.</p>
        </div>
