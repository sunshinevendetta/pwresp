...
export default function DisconnectedPage() {
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center bg-black text-white text-center p-6">
      <h1 className="text-4xl font-bold">Este sitio esta desconectado por falta de pago y sentido de responsabilidad del CEO en DFB (Decentralized Future Builders)</h1>
